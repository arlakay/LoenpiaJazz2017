...
public class PhotoboothTabsActivity extends AppCompatActivity {
    @BindView(R.id.toolbar)Toolbar toolbar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_photobooth_tabs);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new FragmentPhotoboothCapture(), "Take a picture ");
        adapter.addFrag(new FragmentPhotoboothGallery(), "User gallery");
